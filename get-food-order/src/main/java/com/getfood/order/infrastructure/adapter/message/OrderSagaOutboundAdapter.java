...
import static com.getfood.order.application.config.kafka.KafkaTopics.CREATE_TICKET_TOPIC;
import static com.getfood.order.application.config.kafka.KafkaTopics.VERIFY_COURIER_TOPIC;
