...
(
    RESTAURANT_ADDRESS_ID UUID         NOT NULL PRIMARY KEY,
...
(
    ...
    CONSTRAINT RESTAURANT_ADDRESS_ID FOREIGN KEY (ADDRESS_ID) REFERENCES RESTAURANT_ADDRESS (RESTAURANT_ADDRESS_ID)
);